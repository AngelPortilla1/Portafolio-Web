...
export default function Navbar() {
  return (
    <nav className="fixed top-0 inset-x-0 z-50 h-[60px] flex items-center justify-between px-8 bg-metal-900/90 backdrop-blur-md border-b border-metal-700/50 transition-colors duration-300">
      <a
        href="#hero"
